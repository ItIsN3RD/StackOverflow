            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body" style="background-color: #3b454f; border-bottom-left-radius: 0.25rem !important; border-bottom-right-radius: 0.25rem !important;">
                        <canvas id="myChart1" width="1250" height="250px"></canvas>
                        <script>
...
/*                                echo "labels: [";
        ...
        <div class="row">
            <div class="col" style="width: 625px; max-height: 250px;">
                <div class="card mb-4 rounded-3" style="background-color: rgba(255,255,255,0%);">
                    <div class="card-body" style="border-bottom-left-radius: 0.25rem !important; border-bottom-right-radius: 0.25rem !important; padding: 0;">
                        <div class="input-group" style="position: relative;">
                            <div style="width: 100%; padding-right: 5px;">
                                <div style="background-color: #3b454f;">
                                    <h6 style="text-align: left; color: white; width: 100%; margin: 0; padding-left: 5px;">Subscriptions</h6>
                                    <div class="input-group" style="position: relative; padding-left: 5px;">
                                        <h3 style="text-align: left; color: white; padding-right: 5px; margin: 0;">543</h3>
                                        <h6 style="background-color: rgba(255,255,255,0); color: rgb(15,255,0); margin: 0; display: flex; justify-content: center; align-items: center; text-align: center; margin-top: 0.5rem; margin-bottom: 0.5rem;">+50%</h6>
                                    </div>
                                </div>
                                <canvas id="myChart1" width="1250" height="250px" style="background-color: #3b454f;"></canvas>
                                <script>
                                    var ctx1 = document.getElementById('myChart1').getContext('2d');
                                    const DATA_COUNT1 = 7;
                                    const NUMBER_CFG1 = {count: DATA_COUNT1, min: -100, max: 100};
                    ...
                    <div class="card-body" style="border-bottom-left-radius: 0.25rem !important; border-bottom-right-radius: 0.25rem !important; padding: 0;">
                        <div class="input-group" style="position: relative;">
                            <div style="width: 50%; padding-right: 5px;">
                                ...
                                <canvas id="myChart2" width="650" height="250" style="background-color: #3b454f;"></canvas>
                                <script>
                            ...
                            <div style="width: 50%; padding-left: 8px;">
                                <div style="background-color: #3b454f;">
                                    <h6 style="text-align: left; color: white; width: 100%; margin: 0; padding-left: 5px;">One-Time Payments</h6>
                                    <div class="input-group" style="position: relative; padding-left: 5px;">
                                        <h3 style="text-align: left; color: white; padding-right: 5px; margin: 0;">543</h3>
                                        <h6 style="background-color: rgba(255,255,255,0); color: rgb(15,255,0); margin: 0; display: flex; justify-content: center; align-items: center; text-align: center; margin-top: 0.5rem; margin-bottom: 0.5rem;">+50%</h6>
                                    </div>
                                </div>
                                <canvas id="myChart3" width="650" height="250" style="background-color: #3b454f;"></canvas>
                                <script>
                ...
                <div class="card mb-4 rounded-3" style="background-color: rgba(255,255,255,0%);">
                    <div class="card-body" style="border-bottom-left-radius: 0.25rem !important; border-bottom-right-radius: 0.25rem !important; padding: 0;">
                        <div class="input-group" style="position: relative;">
                            <div style="width: 50%; padding-right: 5px;">
                                <div style="background-color: #3b454f;">
                                    <h6 style="text-align: left; color: white; width: 100%; margin: 0; padding-left: 5px;">Trials</h6>
                                    <div class="input-group" style="position: relative; padding-left: 5px;">
                                        <h3 style="text-align: left; color: white; padding-right: 5px; margin: 0;">543</h3>
                                        <h6 style="background-color: rgba(255,255,255,0); color: rgb(15,255,0); margin: 0; display: flex; justify-content: center; align-items: center; text-align: center; margin-top: 0.5rem; margin-bottom: 0.5rem;">+50%</h6>
                                    </div>
                                </div>
                                <canvas id="myChart5" width="650" height="250" style="background-color: #3b454f;"></canvas>
                                <script>
                            ...
                            <div style="width: 50%; padding-left: 8px;">
                                <div style="background-color: #3b454f;">
                                    <h6 style="text-align: left; color: white; width: 100%; margin: 0; padding-left: 5px;">Cancelations</h6>
                                    <div class="input-group" style="position: relative; padding-left: 5px;">
                                        <h3 style="text-align: left; color: white; padding-right: 5px; margin: 0;">543</h3>
                                        <h6 style="background-color: rgba(255,255,255,0); color: rgb(15,255,0); margin: 0; display: flex; justify-content: center; align-items: center; text-align: center; margin-top: 0.5rem; margin-bottom: 0.5rem;">+50%</h6>
                                    </div>
                                </div>
                                <canvas id="myChart6" width="650" height="250" style="background-color: #3b454f;"></canvas>
                                <script>
