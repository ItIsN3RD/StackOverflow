...
<div id="main-content" onscroll="myFunction(this)" style="overflow: auto;" class="d-flex justify-content-center">
    ...
    <div class="container" style="margin-top: 1.5rem; position: relative !important;">
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header"
                         style="background-color: #3b454f; border-bottom: none;padding-top: 1rem; padding-bottom: 0px;">
                        <div class="input-group">
                            <div>
                                <h6 style="text-align: left; color: white; width: 100%; margin: 0;">Gross Income</h6>
                                <div class="input-group" style="position: relative">
                                    <h3 style="text-align: left; color: white; padding-right: 5px; margin: 0;">
                                        $1350</h3>
                                    <h6 style="background-color: rgba(255,255,255,0); color: rgb(15,255,0); margin: 0; display: flex; justify-content: center; align-items: center; text-align: center; margin-top: 0.5rem; margin-bottom: 0.5rem;">
                                        +50%</h6>
                                </div>
                            </div>
                    ...
                    <div class="card-body"
                         style="background-color: #3b454f; border-bottom-left-radius: 0.25rem !important; border-bottom-right-radius: 0.25rem !important;">
        ...
        <div class="row">
            <div class="input-group">
                <div class="card mb-4 rounded-3 shadow-sm" style="width: 49%; margin-right: 1%;">
                    <div class="card-header"
                         style="background-color: #3b454f; border-bottom: none;padding-top: 1rem; padding-bottom: 0px;">
                        <div class="input-group">
                            <div>
                ...
                <div class="card mb-4 rounded-3 shadow-sm" style="width: 49%; margin-left: 1%;">
                    <div class="card-header"
                         style="background-color: #3b454f; border-bottom: none;padding-top: 1rem; padding-bottom: 0px;">
                        <div class="input-group">
                            <div>
                                <h6 style="text-align: left; color: white; width: 100%; margin: 0;">One-Time
                                    Payments</h6>
                                <div class="input-group" style="position: relative">
        ...
        <div class="row">
            <div class="input-group">
                <div class="card mb-4 rounded-3 shadow-sm" style="width: 49%; margin-right: 1%;">
                    ...
                    <div class="card-body"
                         style="background-color: #3b454f; border-bottom-left-radius: 0.25rem !important; border-bottom-right-radius: 0.25rem !important;">
                        <canvas id="myChart4" width="625" height="250"></canvas>
                        <script>
                            var ctx4 = document.getElementById('myChart4').getContext('2d');
                            const DATA_COUNT4 = 7;
                            const NUMBER_CFG4 = {count: DATA_COUNT4, min: -100, max: 100};
                ...
                <div class="card mb-4 rounded-3 shadow-sm" style="width: 49%; margin-left: 1%;">
                    <div class="card-header"
                        ...
                        <div class="input-group">
                            <div>
                                <h6 style="text-align: left; color: white; width: 100%; margin: 0;">Cancellations</h6>
                                <div class="input-group" style="position: relative">
                                    <h3 style="text-align: left; color: white; padding-right: 5px; margin: 0;">543</h3>
                                    <h6 style="background-color: rgba(255,255,255,0); color: rgb(15,255,0); margin: 0; display: flex; justify-content: center; align-items: center; text-align: center; margin-top: 0.5rem; margin-bottom: 0.5rem;">
                                        +50%</h6>
